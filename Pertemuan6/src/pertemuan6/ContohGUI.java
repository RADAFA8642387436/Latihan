...
public class ContohGUI extends JFrame{
    ...
    JTextField t1=new JTexetField();
    JTextField t2=new JTexetField();
    JTextField t3=new JTexetField();
    ...
    lbl1.setBounds(15,20,80,25);//15 jarak antr pinggir
    lbl2.setBounds(15,55,125,25);
    lbl3setBounds(15,90,125,25);
